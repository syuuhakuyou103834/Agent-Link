...
ZIP CRC 通过；包内 49 个源码文件与修复源码一致；启动器版本 0.3.13.0。包内自带 Python/Qt 的原生窗口渲染通过。使用包内运行库和应用模块的真实 config/read 与三种角色 thread/start 均通过，未发送模型请求。原 0.3.12 ZIP 哈希未变。

新 ZIP SHA-256：`d34e2885df7c1a6875ba49552cadb87d485e30822be340855b427fe1c4917b23`。
