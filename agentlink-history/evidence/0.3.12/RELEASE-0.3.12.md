...
ZIP CRC 通过；包内 48 个源码文件与修复源文件逐一相同；打包运行时的 Windows Qt 主窗口渲染通过；启动器程序集版本 0.3.12.0。旧 0.3.11 ZIP 哈希未变。

新包 SHA-256：`6d7df8812feb482f749c41bcbec65f9d9d2878a97882331fc96deef4756646b1`。
