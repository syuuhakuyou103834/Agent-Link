...
results=[]
for name in ('test_runtime_components.py','test_mcp_overrides.py','test_runtime_discovery.py','test_projects.py','test_code_workflow.py','test_authority.py','test_code_gui.py','test_gui.py'):
