...
ZIP CRC 通过，包内 53 个源码文件逐一匹配；原生 Windows Qt 启动检查通过；包内运行库及应用模块的三种角色真实权限预检均通过，无模型请求。启动器 0.3.14.0。原 0.3.13 ZIP 未变。

ZIP SHA-256：`984d9b1825aa426ce3acc6c0e11a9d985ace46c541c6e8610a2f6113e2c81e90`。
