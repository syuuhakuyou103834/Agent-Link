...
EXTRACT=ROOT/'p2'
archive=ROOT/'dist/AgentLink-GUI-0.3.9-Windows-x64.zip'
...
checks=[]
for name,command in [('identity',[str(EXTRACT/'runtime/python.exe'),'-c','import app;assert app.__version__=="0.3.9";print(app.__version__)']),
