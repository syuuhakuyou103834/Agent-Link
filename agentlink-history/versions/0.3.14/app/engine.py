...
class NodeService(ReviewWorkflow):
    ...
    def _heartbeat(self, force=False):
        ...
        record = {"role": self.settings.role, "host": socket.gethostname(), "pid": os.getpid(),
                  ...
                  "features": [FEATURE, SAFETY_FEATURE, LONG_TASK_FEATURE, PROJECT_FEATURE], "execution": activity}
                        ...
                        try:
                            ...
                            if args.get('mode') == 'code':
                                self.run_code_review(args['topic'], args['rounds'], args.get('project'),
                                    args.get('parent_job_id'), args.get('_dispatch'), args.get('_peer_instance'))
                            else:
