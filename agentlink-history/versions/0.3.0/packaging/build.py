...
def main():
    ...
    for folder in ('app', 'packaging', 'tests'):
    ...
    archive(PORTABLE, DIST / 'AgentLink-GUI-0.3.0-Windows-x64.zip')
    payload = DIST / 'AgentLink-GUI-0.3.0-Windows-x64.zip'
    ...
    compile_cs(TEMP / 'Setup.cs', DIST / 'AgentLink-GUI-Setup.exe', payload)
    files = [DIST / 'AgentLink-GUI-Setup.exe', payload]
